        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: sel
                  ? BoxDecoration(color: Colors.purple.shade500, borderRadius: BorderRadius.circular(20))
                  : null,
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(icon, size: 18, color: sel ? Colors.white : Colors.purple.shade500),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: sel ? Colors.white : Colors.purple.shade500,
                    ),
                  ),
                ],
              ),
